...
export default function AddItemModal({ folders, defaultFolderId, onAdd, onClose }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-gray-900 border border-gray-800 rounded-2xl w-full max-w-lg shadow-2xl">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          <h2 className="text-base font-semibold text-white">Add New Clip</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. API Key, Email Template..."
              autoFocus
          ...
          <div>
            <label className="block text-xs font-medium text-gray-400 mb-1.5">Folder (optional)</label>
            <select
              value={folderId}
